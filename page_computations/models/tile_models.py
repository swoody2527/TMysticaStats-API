...
def fetch_common_score_tile_order(
                                  s_year, e_year, map=None, num_players=None, faction=None):
...
def fetch_popular_bonus_tiles_by_round(s_year, e_year,
                              map=None, num_players=None, faction=None):
...
def fetch_favor_tiles_by_faction(s_year, e_year,
                              map=None, num_players=None, faction=None):
...
def fetch_town_tiles_by_faction(s_year, e_year,
                              map=None, num_players=None, faction=None):
...
def fetch_vp_gained_by_scoring_tile(s_year, e_year,
                                     map=None, num_players=None, faction=None):
    import ast
    import pandas as pd
